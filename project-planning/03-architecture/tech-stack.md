...
- ❌ No UI component library (shadcn/ui, MUI, Radix paid layer) — Radix primitives allowed *only* for dialog/menu accessibility if hand-rolled is judged insufficient; decision recorded (see decision log D-023)
