...
**Sections:** PageHeader → Bio (2–3 paras, first person) → Principles (3–5, editorial) → "How I think about design & engineering" (short essay) → Toolkit (chips: tools/stack) → Career timeline (compact, honest gaps ok) → Personal note (one human detail: coffee, cameras, climbing — A-006) → CTA. *(Résumé link optional F-31.)*
