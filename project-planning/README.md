...
- **Design tokens:** full system in `01-brand/design-guidelines.md` (color, type, spacing, radius, shadow, motion, grid). Tokens are the *only* allowed source for colors/spacing in UI code.
